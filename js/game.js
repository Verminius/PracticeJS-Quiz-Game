...
function save3() {
  ...
  msg3.innerHTML = "Ya usaste esta ayuda!!";
  llamadaBtn.disabled = true;
  setTimeout(() => {
    llamada.classList.remove("visible");
...
function save2() {
  ...
  msg2.innerHTML = "Ya usaste esta ayuda!!";
  publicoBtn.disabled = true;
  setTimeout(() => {
    publico.classList.remove("visible");
...
function save1() {
  ...
  msg1.innerHTML = "Ya usaste esta ayuda!!";
